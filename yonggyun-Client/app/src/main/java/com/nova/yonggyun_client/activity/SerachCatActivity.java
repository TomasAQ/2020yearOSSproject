...
public class SerachCatActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serach_cat);
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder( SerachCatActivity.this);
        builder.setTitle("알림");
